...
from config import RANDOM_SEED, SEQUENCE_LENGTH, ENCODER_TYPE, TAU, LAM, ENCODER_EPOCHS, ENCODER_BATCH_SIZE, BALANCE_ENCODER_DATA, SAVE_MODEL_PATH, N_HEAD, N_LAYER, EMBEDDING_DIM, THRESHOLD
...
hyperparams = {
    'ENCODER_TYPE': f'${ENCODER_TYPE} - ${SAVE_MODEL_PATH}',
