...
class CocoaClassifierTrainer():
    def __init__(self, seq_len, batch_size, x_n_features, y_n_features, encoder_type, embedding_dim, nhead=None, nlayer=None, logger=None):
        ...
        self.model = CocoaClassifier(seq_len, x_n_features, y_n_features, encoder_type, embedding_dim, nhead, nlayer)
