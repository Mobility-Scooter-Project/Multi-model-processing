...
logger = Logger()
log_file_path = logger.start_logging(file_name_prefix="transformer_encoder_pose_only")
logger.log_hyperparameters(hyperparams)

trainer = CocoaClassifierTrainer(SEQUENCE_LENGTH, BATCH_SIZE, POSE_N_FEATURES, EMBEDDING_DIM, logger)
...
for patient in patients:
    trainer.add_data(aligned_data[f"{patient}_pose_arr"], aligned_data[f"{patient}_label_arr"])
